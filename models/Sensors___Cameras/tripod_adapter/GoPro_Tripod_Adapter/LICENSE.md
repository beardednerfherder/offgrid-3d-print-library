...
**Name:** Gopro Tripod Adapter

**Model folder:** `models/Sensors___Cameras/tripod_adapter/GoPro_Tripod_Adapter`

## Files Covered

- `files/gopro_tripod_adapter.scad`
- `files/gopro_tripod_adapter_v3.stl`
