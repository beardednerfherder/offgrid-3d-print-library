...
**Name:** Tripod Adapter For Kinect

**Model folder:** ``models/Sensors___Cameras/tripod_adapter/Tripod_adapter_for_Kinect``

## Files Covered

- `files/kinect-tripod-1.stl`
- `files/kinect-tripod-2.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:6930
