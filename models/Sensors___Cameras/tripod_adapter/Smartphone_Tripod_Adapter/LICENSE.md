...
**Name:** Smartphone Tripod Adapter

**Model folder:** `models/Sensors___Cameras/tripod_adapter/Smartphone_Tripod_Adapter`

## Files Covered

- `files/Uni-Tripod-Mount-Tight-Fit.stl`
- `files/Uni-Tripod-Mount.stl`
