...
**Name:** Ender 3 Webcam Mount

**Model folder:** `models/Sensors___Cameras/camera_mount/Ender_3_Webcam_mount`

## Files Covered

- `files/Ender_3_Webcam_Arm_v2.stl`
- `files/Ender_3_Webcam_Base_v2.stl`
