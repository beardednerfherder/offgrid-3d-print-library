...
**Name:** Center Finder For Edges Set

**Model folder:** `models/Workshop/center_finder_jig/Center_Finder_For_Edges_Set`

## Files Covered

- `files/CenterFinder125.STL`
- `files/CenterFinder175.STL`
- `files/CenterFinder225.STL`
- `files/CenterFinder325.STL`
- `files/CenterFinder425.STL`
