...
**Name:** Gopro Thumb Screw

**Model folder:** `models/Workshop/thumb_screw_knob/gopro_thumb_screw`

## Files Covered

- `files/M5_30mm_thumb_screw.STL`
- `files/M5_35mm_thumb_screw.STL`
- `files/M5_40mm_thumb_screw.STL`
- `files/M5_50mm_thumb_screw.STL`
