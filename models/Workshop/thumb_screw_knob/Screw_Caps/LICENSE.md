...
**Model folder:** ``models/Workshop/thumb_screw_knob/Screw_Caps``

## Files Covered

- `files/SCREW_CAP_M3_KNURLED.stl`
- `files/SCREW_CAP_M3_LOBED.stl`
- `files/SCREW_CAP_M3_WINGED.stl`
- `files/SCREW_CAP_M4_KNURLED.stl`
- `files/SCREW_CAP_M4_LOBED.stl`
- `files/SCREW_CAP_M4_WINGED.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:2186175
