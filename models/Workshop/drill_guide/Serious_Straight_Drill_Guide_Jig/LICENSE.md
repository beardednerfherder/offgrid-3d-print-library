...
**Name:** Serious Straight Drill Guide Jig

**Model folder:** ``models/Workshop/drill_guide/Serious_Straight_Drill_Guide_Jig``

## Files Covered

- `files/SeriousStraightDrillJig.STL`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:1214546

**Creator / author:** UNKNOWN / NEEDS REVIEW

**Matched data file:** _archive/scraper_bootstrap/manifests/license_audit.csv

**Match confidence:** 0.77
