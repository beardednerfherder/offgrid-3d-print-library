...
**Name:** Multi Angle Drill Guide

**Model folder:** `models/Workshop/drill_guide/Multi_Angle_Drill_Guide`

## Files Covered

- `files/adg_BASE.stl`
- `files/adg_center_rig.stl`
- `files/adg_circle.stl`
- `files/adg_head_32mm.stl`
- `files/adg_lock_and_hole_marker.stl`
- `files/adg_lock_nut.stl`
