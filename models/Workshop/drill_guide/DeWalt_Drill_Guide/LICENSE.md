...
**Name:** Dewalt Drill Guide

**Model folder:** `models/Workshop/drill_guide/DeWalt_Drill_Guide`

## Files Covered

- `files/Drill_Guide_v2.stl`
- `files/Drill_Guide_v2_Mount.stl`
- `files/Drill_Guide_v7.f3d`
- `files/Drill_Guide_v7.step`
