...
**Name:** Customizable Socket Organizer

**Model folder:** `models/Workshop/socket_organizer/Customizable_Socket_Organizer`

## Files Covered

- `files/Bespoke_Socket_Holder.scad`
- `files/Bespoke_Socket_Holder.stl`
