...
**Name:** Jaw Set For Vise

**Model folder:** `models/Workshop/soft_vise_jaw/Jaw_set_for_vise`

## Files Covered

- `files/Jaws_on_vise_rhombus_7_.stl`
- `files/Sponges_on_a_vice_rhombus_left.stl`
- `files/Sponges_on_a_vise_.stl`
- `files/Sponges_on_a_vise_rhombus_right.stl`
- `files/The_jaws_on_the_vise_are_thick.stl`
- `files/Vice_jaws_for_cylinder_Left.stl`
- `files/Vice_jaws_for_cylinder_Right.stl`
