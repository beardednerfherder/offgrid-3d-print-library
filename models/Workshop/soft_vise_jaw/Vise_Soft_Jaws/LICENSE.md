...
**Model folder:** ``models/Workshop/soft_vise_jaw/Vise_Soft_Jaws``

## Files Covered

- `files/ViseSoftJaw_3in.STL`
- `files/ViseSoftJaw_4in.STL`
- `files/ViseSoftJaw_5in.STL`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:1376177

**Creator / author:** UNKNOWN / NEEDS REVIEW

**Matched data file:** _archive/scraper_bootstrap/manifests/license_audit.csv

**Match confidence:** 0.69
