...
**Name:** Vise Soft Jaw Strips

**Model folder:** ``models/Workshop/soft_vise_jaw/Vise_soft_jaw_strips``

## Files Covered

- `files/vise_jaw_plate_100mm.stl`
- `files/vise_jaw_plate_120mm.stl`
- `files/vise_jaw_strip_63mm.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:681522
