...
**Name:** Pegboard Mount  Spacer   Washer

**Model folder:** `models/Workshop/spacer_shim_washer/Pegboard_Mount__Spacer___Washer`

## Files Covered

- `files/pegboard-mount-spacer.stl`
- `files/pegboard-mount-washer.stl`
