...
**Name:** Drill Bit Sharpener

**Model folder:** ``models/Workshop/drill_bit_organizer/Drill_bit_sharpener``

## Files Covered

- `files/DrillBitSharpen118.stl`
- `files/DrillBitSharpen118mini.stl`
- `files/DrillBitSharpen135.stl`
- `files/DrillBitSharpen90.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:1024834
