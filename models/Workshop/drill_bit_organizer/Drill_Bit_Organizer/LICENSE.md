...
**Model folder:** `models/Workshop/drill_bit_organizer/Drill_Bit_Organizer`

## Files Covered

- `files/Drill_Bit_Organizer_.f3d`
- `files/Drill_Bit_Organizer_.step`
- `files/Number_Test_Block.stl`
- `files/Tray_1.stl`
- `files/Tray_2.stl`
- `files/Tray_3.stl`
