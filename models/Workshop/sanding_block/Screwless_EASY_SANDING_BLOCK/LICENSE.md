...
**Name:** Screwless Easy Sanding Block

**Model folder:** ``models/Workshop/sanding_block/Screwless_EASY_SANDING_BLOCK``

## Files Covered

- `files/EASY_SANDING_BLOCK.STEP`
- `files/EASY_SANDING_BLOCK_A.STL`
- `files/EASY_SANDING_BLOCK_A_CLOSED.STL`
- `files/EASY_SANDING_BLOCK_B.STL`
- `files/EASY_SANDING_BLOCK_C.STL`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:4655051
