...
**Model folder:** ``models/Workshop/sanding_block/Sanding_block``

## Files Covered

- `files/Sanding_block-Holder.stl`
- `files/Sanding_block-Screw.stl`
- `files/Sanding_block-Upplate.stl`
- `files/Sanding_block_full_model.stl`
