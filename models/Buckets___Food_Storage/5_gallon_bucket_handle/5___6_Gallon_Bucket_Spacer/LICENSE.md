...
**Name:** 5   6 Gallon Bucket Spacer

**Model folder:** `models/Buckets___Food_Storage/5_gallon_bucket_handle/5___6_Gallon_Bucket_Spacer`

## Files Covered

- `files/Bucket_Divider.stl`
- `files/Divider_Hub_V2.stl`
