...
**Name:** Mason Jar Filter Funnel

**Model folder:** `models/Buckets___Food_Storage/jar_funnel/Mason_Jar_Filter_Funnel`

## Files Covered

- `files/MasonJarFilterFunnel.stl`
- `files/MasonJarFilterFunnel_v3.f3d`
