...
**Name:** Pegboard Heavy Duty Hanging Bin Clip

**Model folder:** ``models/Buckets___Food_Storage/bag_clip_heavy_duty/Pegboard_Heavy-Duty_Hanging_Bin_Clip``

## Files Covered

- `files/akrobin_clip_slim.STEP`
- `files/akrobin_clip_slim.STL`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:1540038
