...
**Name:** Can Opener And Lid

**Model folder:** `models/Buckets___Food_Storage/bucket_lid_opener/Can_opener_and_lid`

## Files Covered

- `files/CanLidOpenerLid.3mf`
- `files/CanLidOpenerLid.stl`
- `files/CanLidOpenerLid_v3.5.stl`
