...
**Model folder:** `models/Buckets___Food_Storage/mason_jar_storage_cap/Canning_Jar_Lids`

## Files Covered

- `files/canning_jar_lids.scad`
- `files/regular_mouth_jar_lid.stl`
- `files/wide_mouth_jar_lid.stl`
