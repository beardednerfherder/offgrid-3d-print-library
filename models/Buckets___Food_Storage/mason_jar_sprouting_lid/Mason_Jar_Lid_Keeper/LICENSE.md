...
**Name:** Mason Jar Lid Keeper

**Model folder:** ``models/Buckets___Food_Storage/mason_jar_sprouting_lid/Mason_Jar_Lid_Keeper``

## Files Covered

- `files/OriginalMasonJarLidKeeper.stl`
- `files/RegularMouth_OpenTop_LidKeeper.stl`
- `files/WideMouth_OpenTop_LidKeeper.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:4356934
