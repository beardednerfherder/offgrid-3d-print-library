...
**Name:** Mason Jar Lid Holder

**Model folder:** `models/Buckets___Food_Storage/mason_jar_sprouting_lid/Mason_Jar_Lid_Holder`

## Files Covered

- `files/Mason_Jar_Ring_Holder_Large_V4.stl`
- `files/Mason_Jar_Ring_Holder_Small_V4.stl`
- `files/Mason_Lid_Holder_Large_V2.stl`
- `files/Mason_Lid_Holder_Small_V2.stl`
