...
**Name:** Canning Jar Sprouting Lid

**Model folder:** `models/Buckets___Food_Storage/mason_jar_sprouting_lid/Canning_Jar_Sprouting_Lid`

## Files Covered

- `files/canning_jar_sprouterv2.scad`
- `files/regular_mouth_jar_sprouter.stl`
- `files/wide_mouth_jar_sprouter.stl`
