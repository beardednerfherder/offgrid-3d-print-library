...
**Name:** Car Fuse Holder For Pcb Mounting

**Model folder:** `models/Low-voltage___Solar/fuse_holder_mount/Car_fuse_holder_for_PCB_mounting`

## Files Covered

- `files/fuseholder.scad`
- `files/fuseholder.stl`
