...
**Name:** Din Rail Stand Kit

**Model folder:** `models/Low-voltage___Solar/DIN_rail_mount/DIN_Rail_Stand_KIT`

## Files Covered

- `files/DIN_Rail_35_Stand_Light.stl`
- `files/DIN_Rail_35_Stand_Light_IEC_socket_female.stl`
- `files/DIN_Rail_35_Stand_Light_IEC_socket_male.stl`
- `files/DIN_Rail_35_Stand_Pro.stl`
