...
**Name:** Zip Tie Mount  20 Mm 

**Model folder:** `models/Low-voltage___Solar/zip_tie_mount/Zip_tie_mount__20_mm_`

## Files Covered

- `files/Zip_tie_mount_anchor-v1.stl`
- `files/Zip_tie_mount_anchor-v1_holed.stl`
- `files/Zip_tie_mount_anchor-v2.stl`
- `files/Zip_tie_mount_anchor-v2_hole.stl`
