...
**Name:** Customizable Cable Tie

**Model folder:** `models/Low-voltage___Solar/zip_tie_mount/Customizable_Cable_Tie`

## Files Covered

- `files/Cable_Tie.scad`
- `files/Cable_Tie1.stl`
- `files/Cable_Tie2.stl`
