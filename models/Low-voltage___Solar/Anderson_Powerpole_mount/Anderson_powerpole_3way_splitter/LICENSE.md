...
**Name:** Anderson Powerpole 3Way Splitter

**Model folder:** `models/Low-voltage___Solar/Anderson_Powerpole_mount/Anderson_powerpole_3way_splitter`

## Files Covered

- `files/ADPP_bottom.stl`
- `files/ADPP_top.stl`
