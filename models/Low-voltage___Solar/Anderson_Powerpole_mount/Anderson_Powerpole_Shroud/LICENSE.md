...
**Name:** Anderson Powerpole Shroud

**Model folder:** `models/Low-voltage___Solar/Anderson_Powerpole_mount/Anderson_Powerpole_Shroud`

## Files Covered

- `files/Powerpole-0.16.stl`
- `files/Powerpole-0.55in-extended.stl`
- `files/Powerpole-0.55in.stl`
- `files/Powerpole.stl`
