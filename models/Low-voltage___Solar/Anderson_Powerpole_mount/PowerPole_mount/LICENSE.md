...
**Name:** Powerpole Mount

**Model folder:** `models/Low-voltage___Solar/Anderson_Powerpole_mount/PowerPole_mount`

## Files Covered

- `files/PowerPole_Double.STL`
- `files/PowerPole_Double_Large.STL`
- `files/PowerPole_Double_Notch.STL`
- `files/PowerPole_Double_Notch_Large.STL`
- `files/PowerPole_Nut.STL`
- `files/PowerPole_Nut_Large.STL`
- `files/PowerPole_Simple.STL`
- `files/PowerPole_Simple_Large.STL`
- `files/PowerPole_Simple_Notch.STL`
- `files/PowerPole_Simple_Notch_Large.STL`
