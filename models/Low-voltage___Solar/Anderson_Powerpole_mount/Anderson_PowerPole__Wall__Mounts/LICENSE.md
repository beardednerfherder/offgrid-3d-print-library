...
**Name:** Anderson PowerPole "Wall" Mounts

**Model folder:** ``models/Low-voltage___Solar/Anderson_Powerpole_mount/Anderson_PowerPole__Wall__Mounts``

## Files Covered

- `files/andersonpowerpole_mini.stl`
- `files/andersonpowerpolemount.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:1205771
