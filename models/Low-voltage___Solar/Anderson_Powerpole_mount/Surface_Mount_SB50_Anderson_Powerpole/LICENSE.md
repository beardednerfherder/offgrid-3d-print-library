...
**Name:** Surface Mount Sb50 Anderson Powerpole

**Model folder:** `models/Low-voltage___Solar/Anderson_Powerpole_mount/Surface_Mount_SB50_Anderson_Powerpole`

## Files Covered

- `files/Anderson_Plug_Flush_Mount_Bottom.stl`
- `files/Anderson_Plug_Flush_Mount_Top.stl`
- `files/V2_Anderson_Plug_Flush_Mount_Bottom.stl`
- `files/V2_Anderson_Plug_Flush_Mount_Top.stl`
