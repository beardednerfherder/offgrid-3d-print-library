...
**Name:** Parametric BNC dust cap

**Model folder:** ``models/Low-voltage___Solar/MC4_dust_cap/Parametric_BNC_dust_cap``

## Files Covered

- `files/bnc_dust_cap.scad`
- `files/bnc_dust_cap.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:620943

**Creator / author:** UNKNOWN / NEEDS REVIEW

**Matched data file:** _archive/scraper_bootstrap/manifests/license_audit.csv

**Match confidence:** 1.50
