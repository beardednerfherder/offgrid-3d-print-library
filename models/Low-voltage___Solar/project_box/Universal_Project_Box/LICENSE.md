...
**Name:** Universal Project Box

**Model folder:** `models/Low-voltage___Solar/project_box/Universal_Project_Box`

## Files Covered

- `files/120x80x45_Lid.stl`
- `files/120x80x45_Lid_for_printing_face_up.stl`
- `files/120x80x45_Lid_without_lip.stl`
- `files/120x80x45_Main_Body.stl`
- `files/120x80x45_Main_Body_without_lip_Customizable_project_box_v2_v3.stl`
- `files/Customizable_project_box_STEP.step`
- `files/Customizable_project_box_v2_v3.f3d`
