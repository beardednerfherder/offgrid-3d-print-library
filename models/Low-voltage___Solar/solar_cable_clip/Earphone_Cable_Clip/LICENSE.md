...
**Name:** Earphone Cable Clip

**Model folder:** ``models/Low-voltage___Solar/solar_cable_clip/Earphone_Cable_Clip``

## Files Covered

- `files/Earphone_Cable_Clip.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:2261211

**Creator / author:** UNKNOWN / NEEDS REVIEW

**Matched data file:** _archive/scraper_bootstrap/manifests/license_audit.csv

**Match confidence:** 1.14
