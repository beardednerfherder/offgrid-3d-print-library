...
**Name:** Poultry Nipple Wrench  Horizontal Install

**Model folder:** ``models/07_Chicken_Coop_Livestock/Poultry Nipple Wrench _horizontal install_``
