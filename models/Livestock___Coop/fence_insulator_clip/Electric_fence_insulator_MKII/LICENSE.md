...
**Name:** Electric Fence Insulator Mkii

**Model folder:** `models/Livestock___Coop/fence_insulator_clip/Electric_fence_insulator_MKII`

## Files Covered

- `files/Electric_fence_insulator.stl`
