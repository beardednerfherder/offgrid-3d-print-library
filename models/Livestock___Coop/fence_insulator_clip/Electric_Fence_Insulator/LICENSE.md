...
**Name:** Electric Fence Insulator

**Model folder:** `models/Livestock___Coop/fence_insulator_clip/Electric_Fence_Insulator`

## Files Covered

- `files/Electric_Fence_insulator_pin_v4.STL`
- `files/Electric_Fence_insulator_v3.STL`
- `files/electric_fence_light.stl`
