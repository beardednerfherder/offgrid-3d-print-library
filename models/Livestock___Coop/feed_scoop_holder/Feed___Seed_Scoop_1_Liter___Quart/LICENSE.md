...
**Name:** Feed   Seed Scoop 1 Liter   Quart

**Model folder:** ``models/Livestock___Coop/feed_scoop_holder/Feed___Seed_Scoop_1_Liter___Quart``

## Files Covered

- `files/Scoop.3mf`
- `files/Scoop_Colsed.stl`
- `files/Scoop_Open.stl`
- `files/Scoop_v2.3mf`
