...
**Name:** Z18 Side Mount Spool Holder

**Model folder:** `models/Livestock___Coop/feed_scoop_holder/Z18_Side_Mount_Spool_Holder`

## Files Covered

- `files/Side_Z18_Spool_Holder.stl`
- `files/Side_Z18_Spool_Holder_WIDE.stl`
- `files/Side_Z18_Spool_Holder_X-WIDE.stl`
- `files/Z18_Filament_Guide.stl`
