...
**Name:** Sliding Closet Door Floor Guide

**Model folder:** `models/Livestock___Coop/coop_door_guide_bracket/Sliding_Closet_Door_floor_guide`

## Files Covered

- `files/SlideClosetBrkt2.stl`
