...
**Name:** Pvc Corner Bracket

**Model folder:** ``models/Livestock___Coop/PVC_feeder_bracket/PVC_corner_bracket``

## Files Covered

- `files/pvc-corner.scad`
- `files/pvc-corner.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:5326169

**Creator / author:** UNKNOWN / NEEDS REVIEW

**Matched data file:** _archive/scraper_bootstrap/manifests/license_audit.csv

**Match confidence:** 1.47
