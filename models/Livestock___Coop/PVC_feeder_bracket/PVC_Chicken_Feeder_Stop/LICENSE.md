...
**Name:** Pvc Chicken Feeder Stop

**Model folder:** ``models/Livestock___Coop/PVC_feeder_bracket/PVC_Chicken_Feeder_Stop``

## Files Covered

- `files/PVC_Chicken_Feeder_Stop.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:6807216

**Creator / author:** UNKNOWN / NEEDS REVIEW

**Matched data file:** _archive/scraper_bootstrap/manifests/license_audit.csv

**Match confidence:** 1.13
