...
**Name:** Egg End Insulator wire antenna

**Model folder:** ``models/09_Radio_Comms_Sensors/Egg End Insulator _wire antenna_``

## Files Covered

- `GuyInsulator10mm.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:3557846

**Creator / author:** UNKNOWN / NEEDS REVIEW

**Matched data file:** _archive/old_attempts/models.csv

**Match confidence:** 1.03
