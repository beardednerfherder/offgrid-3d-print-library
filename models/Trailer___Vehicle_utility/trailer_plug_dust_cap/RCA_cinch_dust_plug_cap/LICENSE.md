...
**Name:** Rca Cinch Dust Plug Cap

**Model folder:** ``models/Trailer___Vehicle_utility/trailer_plug_dust_cap/RCA_cinch_dust_plug_cap``

## Files Covered

- `files/RCA_cinch_dust_plug_cap.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:2517224

**Creator / author:** UNKNOWN / NEEDS REVIEW

**Matched data file:** _archive/scraper_bootstrap/manifests/license_audit.csv

**Match confidence:** 1.17
