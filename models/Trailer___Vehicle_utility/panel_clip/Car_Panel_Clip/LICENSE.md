...
**Model folder:** `models/Trailer___Vehicle_utility/panel_clip/Car_Panel_Clip`

## Files Covered

- `files/2029_panel_clipA.stl`
- `files/2029_panel_clipA2.stl`
- `files/2029_panel_clipB.stl`
- `files/2029_panel_clipB2.stl`
- `files/combined_panel_clip_print.stl`
