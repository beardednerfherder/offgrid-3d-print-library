...
**Name:** Auto Panel Clip

**Model folder:** ``models/Trailer___Vehicle_utility/panel_clip/Auto_Panel_Clip``

## Files Covered

- `files/auto_panel_clip-_solid.stl`
- `files/auto_plug_clip.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:5166144
