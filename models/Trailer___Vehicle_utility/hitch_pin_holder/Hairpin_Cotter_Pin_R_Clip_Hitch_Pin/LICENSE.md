...
**Name:** Hairpin Cotter Pin R Clip Hitch Pin

**Model folder:** `models/Trailer___Vehicle_utility/hitch_pin_holder/Hairpin_Cotter_Pin_R_Clip_Hitch_Pin`

## Files Covered

- `files/20248_R-clip_v1.stl`
