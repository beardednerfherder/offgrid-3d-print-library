...
**Name:** Ropesnap   Tent Line Tensioner

**Model folder:** ``models/Comms/guy_line_tensioner/RopeSnap_-_Tent_line_tensioner``

## Files Covered

- `files/RopeSnap3mm.stl`
- `files/RopeSnap3mmOpen.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:3398911
