...
**Name:** Ham Radio Dude   Wire Winder   Efhw Winder

**Model folder:** `models/Comms/antenna_wire_winder/Ham_Radio_Dude_-_Wire_Winder___EFHW_Winder`

## Files Covered

- `files/BNC_HRDIndustries_Dudetenna.stl`
- `files/HRDBncWinder.stl`
- `files/HRDINdustriesAntenna.stl`
- `files/Winder_For_Case_With_Text.step`
