...
**Name:** Antenna Wire Winder

**Model folder:** `models/Comms/antenna_wire_winder/Antenna_Wire_Winder`

## Files Covered

- `files/Antenna_Winder.3mf`
- `files/Antenna_Winder.stl`
- `files/Antenna_Winder_Long.3mf`
