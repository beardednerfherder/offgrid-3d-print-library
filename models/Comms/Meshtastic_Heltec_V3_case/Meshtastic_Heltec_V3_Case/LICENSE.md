...
**Name:** Meshtastic Heltec V3 Case

**Model folder:** ``models/Comms/Meshtastic_Heltec_V3_case/Meshtastic_Heltec_V3_Case``

## Files Covered

- `files/N3_Back_Plate.stl`
- `files/N3_Body.stl`
- `files/N3_Button.stl`
- `files/N3_Front_Panel.stl`
