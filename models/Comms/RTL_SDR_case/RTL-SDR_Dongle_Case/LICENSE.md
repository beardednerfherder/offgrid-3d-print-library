...
**Name:** Rtl Sdr Dongle Case

**Model folder:** ``models/Comms/RTL_SDR_case/RTL-SDR_Dongle_Case``

## Files Covered

- `files/rtl-sdr-case.scad`
- `files/rtl-sdr-case.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:768282

**Creator / author:** UNKNOWN / NEEDS REVIEW

**Matched data file:** _archive/scraper_bootstrap/manifests/license_audit.csv

**Match confidence:** 1.33
