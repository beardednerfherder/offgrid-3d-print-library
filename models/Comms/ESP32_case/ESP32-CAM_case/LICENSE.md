...
**Model folder:** `models/Comms/ESP32_case/ESP32-CAM_case`

## Files Covered

- `files/ESP32-CAM-Back-BluePCB.stl`
- `files/ESP32-CAM-Back-GreenPCB.stl`
- `files/ESP32-CAM-Front.stl`
- `files/ESP32-CAM-FrontThicker.stl`
