...
**Name:** Esp32 Devkit Case

**Model folder:** ``models/Comms/ESP32_case/ESP32_devkit_case``

## Files Covered

- `files/esp32-case.f3d`
- `files/esp32-case_cap.stl`
- `files/esp32-case_main.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:4564452

**Creator / author:** UNKNOWN / NEEDS REVIEW

**Matched data file:** _archive/scraper_bootstrap/manifests/license_audit.csv

**Match confidence:** 1.04
