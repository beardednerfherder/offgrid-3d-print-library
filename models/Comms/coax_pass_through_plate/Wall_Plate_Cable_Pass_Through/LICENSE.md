...
**Name:** Wall Plate Cable Pass Through

**Model folder:** `models/Comms/coax_pass_through_plate/Wall_Plate_Cable_Pass_Through`

## Files Covered

- `files/Wall_Plate_Base_-_Cable_Pass_Through_-_Plate.stl`
- `files/Wall_Plate_Base_-_Cable_Pass_Through_-_Plate_and_Slot.stl`
- `files/Wall_Plate_Base_-_Cable_Pass_Through_-_Slot.stl`
