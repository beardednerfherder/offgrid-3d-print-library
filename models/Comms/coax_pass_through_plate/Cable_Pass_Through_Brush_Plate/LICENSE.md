...
**Name:** Cable Pass Through Brush Plate

**Model folder:** ``models/Comms/coax_pass_through_plate/Cable_Pass_Through_Brush_Plate``

## Files Covered

- `files/Cable_pass_through_-_Inside_part.stl`
- `files/Cable_pass_through_-_Outside_part.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:3538504
