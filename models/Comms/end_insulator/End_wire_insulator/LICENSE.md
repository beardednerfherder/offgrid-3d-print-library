...
**Name:** End Wire Insulator

**Model folder:** `models/Comms/end_insulator/End_wire_insulator`

## Files Covered

- `files/line_insulator-Body.step`
- `files/line_insulator-Body.stl`
- `files/line_insulator.FCStd`
