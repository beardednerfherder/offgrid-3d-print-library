...
**Name:** Antenna End Insulator  Dog Bone  Insulator 

**Model folder:** `models/Comms/end_insulator/Antenna_End_Insulator__Dog_Bone__Insulator_`

## Files Covered

- `files/HexInsulator.stl`
