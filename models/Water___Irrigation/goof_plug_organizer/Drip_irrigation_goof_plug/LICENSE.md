...
**Name:** Drip Irrigation Goof Plug

**Model folder:** ``models/Water___Irrigation/goof_plug_organizer/Drip_irrigation_goof_plug``

## Files Covered

- `files/goof-plug-v2.FCStd`
- `files/goof-plug-v2.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:899153
