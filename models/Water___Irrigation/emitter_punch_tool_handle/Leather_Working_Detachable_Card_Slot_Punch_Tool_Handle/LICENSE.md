...
**Name:** Leather Working Detachable Card Slot Punch Tool Handle

**Model folder:** ``models/Water___Irrigation/emitter_punch_tool_handle/Leather_Working_Detachable_Card_Slot_Punch_Tool_Handle``

## Files Covered

- `files/Straight-Blade-Punch-Handle-35mm-wide.stl`
- `files/Straight-Blade-Punch-Handle-70mm-wide.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:5885519
