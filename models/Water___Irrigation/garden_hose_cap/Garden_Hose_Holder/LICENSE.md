...
**Name:** Garden Hose Holder

**Model folder:** `models/Water___Irrigation/garden_hose_cap/Garden_Hose_Holder`

## Files Covered

- `files/hoseHolder-clamp.STL`
- `files/hoseHolder-holder.STL`
- `files/hoseHolder.STL`
