...
**Name:** Garden Hose Coupler

**Model folder:** `models/Water___Irrigation/garden_hose_cap/Garden_hose_Coupler`

## Files Covered

- `files/Hose_quickcon_01.STL`
- `files/Hose_quickcon_02.STL`
