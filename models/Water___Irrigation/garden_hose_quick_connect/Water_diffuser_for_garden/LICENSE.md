...
**Name:** Water Diffuser For Garden

**Model folder:** ``models/Water___Irrigation/garden_hose_quick_connect/Water_diffuser_for_garden``

## Files Covered

- `files/water_diffuser_v1.stl`
- `files/water_diffuser_v2.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:4599284
