...
**Name:** Quick Garden Male Connector Into Hose 13Mm

**Model folder:** `models/Water___Irrigation/garden_hose_quick_connect/Quick_garden_male_connector_into_hose_13mm`

## Files Covered

- `files/gardena_to_hose_13.STL`
- `files/gardena_to_hose_13_s.STL`
- `files/gardena_to_hose_13_v2.STEP`
- `files/gardena_to_hose_13_v2.STL`
