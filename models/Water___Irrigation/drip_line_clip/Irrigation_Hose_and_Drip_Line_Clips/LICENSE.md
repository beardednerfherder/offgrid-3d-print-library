...
**Name:** Irrigation Hose And Drip Line Clips

**Model folder:** `models/Water___Irrigation/drip_line_clip/Irrigation_Hose_and_Drip_Line_Clips`

## Files Covered

- `files/clip_250dia.stl`
- `files/clip_700dia.stl`
