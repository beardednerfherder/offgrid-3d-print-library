...
**Name:** 4Mm Drip Line T Connector

**Model folder:** ``models/Water___Irrigation/drip_line_clip/4mm_drip_line_T_connector``

## Files Covered

- `files/4mm_End_Plug.stl`
- `files/4mm_T-connector.scad`
- `files/4mm_T-connector.stl`
- `files/4mm_X-connector.stl`
- `files/4mm_straight-connector.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:6234451
