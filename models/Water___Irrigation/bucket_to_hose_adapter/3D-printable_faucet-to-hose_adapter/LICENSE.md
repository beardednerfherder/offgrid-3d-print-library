...
**Name:** 3D Printable Faucet To Hose Adapter

**Model folder:** `models/Water___Irrigation/bucket_to_hose_adapter/3D-printable_faucet-to-hose_adapter`

## Files Covered

- `files/3D-printable_faucet-to-hose_adapter_-_By_CreativeTools.se.stl`
