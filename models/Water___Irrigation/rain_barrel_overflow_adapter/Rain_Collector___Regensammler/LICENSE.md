...
**Name:** Rain Collector   Regensammler

**Model folder:** `models/Water___Irrigation/rain_barrel_overflow_adapter/Rain_Collector___Regensammler`

## Files Covered

- `files/Dachrinne_Regenablauf_-_Tonne_Anschluss_new.stl`
- `files/Regentonne_Auslass_Anschluss__berlauf.stl`
