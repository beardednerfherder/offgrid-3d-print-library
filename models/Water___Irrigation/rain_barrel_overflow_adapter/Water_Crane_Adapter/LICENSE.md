...
**Name:** Water Crane Adapter

**Model folder:** `models/Water___Irrigation/rain_barrel_overflow_adapter/Water_Crane_Adapter`

## Files Covered

- `files/Krank_Adapter_Tonne_auf_halber_Zoll_Schlauch.stl`
