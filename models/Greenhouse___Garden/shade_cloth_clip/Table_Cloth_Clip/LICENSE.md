...
**Name:** Table Cloth Clip

**Model folder:** ``models/Greenhouse___Garden/shade_cloth_clip/Table_Cloth_Clip``

## Files Covered

- `files/TableClothClip.stl`
- `files/Table_Cloth_Clip.stl`

## Source

**Source site:** thingiverse

**Original URL:** https://www.thingiverse.com/thing:1588741

**Creator / author:** UNKNOWN / NEEDS REVIEW

**Matched data file:** _archive/scraper_bootstrap/manifests/license_audit.csv

**Match confidence:** 1.11
