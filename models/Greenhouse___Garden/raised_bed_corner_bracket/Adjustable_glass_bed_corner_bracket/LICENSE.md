...
**Name:** Adjustable Glass Bed Corner Bracket

**Model folder:** `models/Greenhouse___Garden/raised_bed_corner_bracket/Adjustable_glass_bed_corner_bracket`

## Files Covered

- `files/glass_clip-slot.stl`
- `files/glass_clip.stl`
