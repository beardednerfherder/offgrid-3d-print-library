...
**Name:** Garden String Clip

**Model folder:** `models/Greenhouse___Garden/trellis_clip/Garden_String_Clip`

## Files Covered

- `files/Garden_String_Tie_4.STL`
- `files/Garden_String_Tie_4_multi.STL`
