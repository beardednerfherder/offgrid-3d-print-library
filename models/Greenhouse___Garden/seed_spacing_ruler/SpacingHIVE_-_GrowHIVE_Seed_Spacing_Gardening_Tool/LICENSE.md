...
**Name:** Spacinghive   Growhive Seed Spacing Gardening Tool

**Model folder:** `models/Greenhouse___Garden/seed_spacing_ruler/SpacingHIVE_-_GrowHIVE_Seed_Spacing_Gardening_Tool`

## Files Covered

- `files/SpacingHIVE.stl`
