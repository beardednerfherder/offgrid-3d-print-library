...
**Name:** Greenhouse Clip  Customizable 

**Model folder:** `models/Greenhouse___Garden/greenhouse_clip/Greenhouse_Clip__customizable_`

## Files Covered

- `files/GreenhouseClip.scad`
- `files/GreenhouseClip.stl`
- `files/GreenhouseClip_orient90.stl`
